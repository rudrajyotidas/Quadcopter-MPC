...
state_input_constraints = (umin, umax, xmin, xmax)
...
prob, references, x_init, u = ctrl.MPCTracking(P, Q, R, N, state_input_constraints)
...
# Generate Trajectory
trajGen = Trajectory(0.1, (timesteps+N)*Ts)
trajGen.CircularTraj(3, np.pi/4)
...
for i in range(timesteps):
    ...
    U_ctrl = Uhover + (u.value[:, 0])[:, np.newaxis]
